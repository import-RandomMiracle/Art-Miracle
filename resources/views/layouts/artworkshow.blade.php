<div class="float-left mr-12">
    <ul>
        ...
        <li class="flex space-x-20">
            <h1 class="text-white text-2xl font-semibold mb-2">5.00 AC</h1>
        ...
        <li>
            <h1 class="text-white text-2xl font-semibold mb-2">30 POINT</h1>
        </li>
        <li>
            <div>
                <p class="text-white mt-2 font-bold">Creator</p>
                    <ul class="flex">
                        <li>
