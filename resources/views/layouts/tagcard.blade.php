@foreach($tags['data'] as $tag)
    <div class="flex space-x-5">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FFFFFF" class="bi bi-postcard-fill svgButton" viewBox="0 0 16 16">
            ...
            <h1 class="text-white">{{$tag['tag_name']}}</h1>
    </div>
@endforeach