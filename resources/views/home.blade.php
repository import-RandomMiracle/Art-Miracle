...
@section('content')
    ...
    <div class="flex justify-center m-20">
        <div class="rectangle">
            <ul class="flex justify-center mt-7">
                ...
                <li>
                    <button class="recButton mr-10 text-xl text-white" onclick="document.location='/artist'">
    ...
    <div class="flex justify-center" class="relative w-full flex gap-6 snap-x snap-mandatory overflow-x-auto pb-5">
