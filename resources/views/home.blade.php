    ...
    <div class="flex justify-center m-20">
        <div >
            <ul class="flex justify-center mt-7 rectangle">
                ...
                <li class="mt-2.5 m-2.5">
                    <button class="recButton text-xl text-white" onclick="document.location='/category'">
                ...
                <li class="mt-2.5 m-2.5">
                    <button class="recButton text-xl text-white" onclick="document.location='/tag'">
                ...
                <li class="mt-2.5 m-2.5">
                    <button class="recButton text-xl text-white" onclick="document.location='/account'">
