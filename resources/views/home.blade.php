        ...
        <div class="flex justify-center ">
            <div class="rectangle">
                    <ul class="flex justify-center mt-2 relative w-full flex gap-6 snap-x snap-mandatory overflow-x-auto pb-5">
                        ...
                        <li>
                            <button class="snap-start recButton pause mr-2 ml-1 text-xl align-center text-white" onclick="document.location='/artwork'">
                        ...
                        <li>
                            <button class="snap-start recButton mr-10 text-xl text-white" onclick="document.location='/artist'">
                        ...
                        <li>
                            <button class="snap-start recButton mr-10 text-xl text-white">
