...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Fonts -->
        <link href="https://fonts.bunny.net/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
        <link href="/Users/freelance/University/01418442_Webtech/Project/Art-Miracle/resources/css/app.css" rel="stylesheet" href="ass.css">
    ...
    <body class="antialiased">
        <div class="flex items-top justify-center min-h-screen sm:items-center backgroundWelcome">
            <div class="topnav">
                <div>
                    @if (Route::has('login'))
                    <div class="hidden fixed top-0 left-0 px-6 py-4 sm:block">
                        <a style="float:left" href="home">
                            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#F08080" class="bi bi-box-seam-fill" viewBox="0 0 16 16">
                    ...
                    <div class="hidden fixed top-0 right-0 mt-4 px-6 py-4 sm:block">
                        ...
                        @else
                            ...
                            <input class="ml-4" style="float: left" type="text" placeholder="Search..">
